		...
		<div class="content_right">
			...
			<dl class="category recent_post">
				...
				<dd><a title="<?php echo CHtml::encode($lp->title);?>" href="<?php echo $this->createUrl('album/view', array('id'=>$lp->id));?>"><?php echo Helper::truncate_utf8_string($lp->title,18);?></a></dd>
				<?php endforeach;?>					
			</dl>		
		</div>
