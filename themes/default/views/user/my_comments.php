...
<div class="user clear">
    ...
    <div class="user_right">		
        <div class="user_edit">			
            <h3><?php echo Yii::t('common', 'My Comments'); ?></h3>
            <?php
            ...
            <table class="form_table">
                <tr class="tb_header">
                    ...
                    <th><?php echo Yii::t('model', 'CommentTitle'); ?></th>
                    <th width="25%"><?php echo Yii::t('model', 'CommentContent'); ?></th>		
                    <th><?php echo Yii::t('model', 'CommentStatus'); ?></th>	      
                    <th width="15%"><?php echo Yii::t('model', 'CommentCreateTime'); ?></th>
                    <th><?php echo Yii::t('admin', 'Operate'); ?></th>
                </tr>
                <?php foreach ((array) $datalist as $row): ?>
                    <tr class="tb_list">
                        <td  class="first_title"><?php echo $row->id ?></td>
                        <td>
