        ...
        <div class="user_edit">			
            ...
            <table class="form_table">
                ...
                <?php foreach ((array) $datalist as $row): ?>
                    <tr class="tb_list">
                        <td  class="first_title"><input type="checkbox" name="id[]" value="<?php echo $row->id ?>"><?php echo $row->id ?></td>
                        <td>
                            <a href="<?php echo $this->createUrl('user/space', array('id' => $row->friend_user_id)); ?>" title="<?php echo $row->friend_name; ?>" target="_blank" ><?php echo $row->friend_name; ?></a>
                        </td>
                        <td>			      	
                            <a href="<?php echo $this->createUrl('user/cancel', array('op' => 'friend', 'id' => $row->id)) ?>" class="confirmSubmit">
                                <img src="<?php echo $this->_static_public; ?>/images/delete.png" align="absmiddle" />
                            </a>&nbsp;&nbsp;
                            <a href="<?php echo $this->createUrl('user/space', array('id' => $row->friend_user_id)); ?>" target="_blank"><img src="<?php echo $this->_static_public; ?>/images/view.png" align="absmiddle" /></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <tr class="operate">
