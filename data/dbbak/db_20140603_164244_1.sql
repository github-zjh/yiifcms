...
INSERT INTO `yii_mail_log` VALUES('15','xb_zjh@126.com','重设邮箱','<p>尊敬的用户：{testUser} 您好，您已经申请修改邮箱操作，请输入下面的验证码进行验证：<br/><br/>
						{941606}<br/><br/>
						==================<br/><br/>如果不是您本人操作，请尽快联系本网站的管理员：<a href=\"mailto:{xb_zjh@126.com}\">{xb_zjh@126.com}</a>。</p>','1401782862','success','3','1','');
INSERT INTO `yii_mail_log` VALUES('16','1441044277@qq.com','重设邮箱','<p>尊敬的用户：testUser 您好，您已经申请修改邮箱操作，请输入下面的验证码进行验证：<br/><br/>
						895844<br/><br/>
						==================<br/><br/>如果不是您本人操作，请尽快联系本网站的管理员：<a href=\"mailto:xb_zjh@126.com\">xb_zjh@126.com</a>。</p>','1401783826','success','3','1','');
INSERT INTO `yii_mail_log` VALUES('17','1441044277@qq.com','重设邮箱','<p>尊敬的用户：testUser 您好，您已经申请修改邮箱操作，请输入下面的验证码进行验证：<br/><br/>
						718976<br/><br/>
						==================<br/><br/>如果不是您本人操作，请尽快联系本网站的管理员：<a href=\"mailto:xb_zjh@126.com\">xb_zjh@126.com</a>。</p>','1401784431','success','3','1','');
INSERT INTO `yii_mail_log` VALUES('18','1441044277@qq.com','重设邮箱','<p>尊敬的用户：testUser 您好，您已经申请修改邮箱操作，请输入下面的验证码进行验证：<br/><br/>
						119147<br/><br/>
						==================<br/><br/>如果不是您本人操作，请尽快联系本网站的管理员：<a href=\"mailto:xb_zjh@126.com\">xb_zjh@126.com</a>。</p>','1401784617','success','3','1','');
...
INSERT INTO `yii_post` VALUES('15','1','Groupon收购本地体验初创公司SideTour','','a:1:{s:5:\"color\";s:0:\"\";}','','','2','1','','','','','','<p>	据国外媒体报道，团购巨人Groupon今日宣布，公司已经收购了本地体验初创公司SideTour。后者是一个帮助人们发现、预订和参加本地活动的市场平台，Groupon没有透露这项收购交易的具体条款。</p><p>	SideTour精选了一些独具特色且有人主持的聚会类活动，让客户们能够与相应领域的资深专家面对面地交流，从而更加了解自己所在的城市和他们关心的事。</p><p>	GrouponLive业务总经理格雷格鲁丁（Greg Rudin）称：“SideTour精心策划的各种本地体验将进一步拓展Groupon的愿景，也就是将Groupon打造成消费者可以随时随地访问的平台。如果Groupon能够提供这些极具个性化的活动、旅游和值得铭记的聚会，我们就能够为我们的客户提供更多有趣的方法，帮助他们探索和发现最好的本地体验。”</p><p>	那些活动大多为私人聚会，人数平均在12人左右，涵盖的行业包括视频、饮料、建筑、历史、艺术等等。SideTour目前提供的公开和私人聚会多达500多种，使用这个平台的聚会主持超过了400人。那些主持者包括厨师、艺术家、奥运金牌获得者、星探和品酒师等等。</p><p>	SideTour的首席执行官韦平戈亚尔（Vipin Goyal）称：“我们很高兴有机会把我们独创的聚会服务提供给这么多热衷于本地体验的人。Groupon可以帮助我们发现更多的本地专家并为他们提供一个与更多客户沟通的平台。”</p><p>	SideTour将继续独立经营一段时间，Groupon将通过其电子邮件、网页和移动渠道向它的4300万活跃用户推广SideTour的聚会服务。</p><p>	SideTour创立于2011年，目前在芝加哥、纽约、费城和华盛顿特区设有办事机构。它计划在未来几个月里开辟更多的市场。</p>','','','','','4','Y','Y','uploads/201309/523a54c220262.jpg','uploads/201309/thumb_523a54c220262.jpg','0','0','N','0','0','Y','0','Y','1379554498');
...
CREATE TABLE `yii_upload` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='附件';
...
INSERT INTO `yii_user` VALUES('31','testUser','$2a$08$QuvI8Ory.KMdKvmaCV/g9O8AoVTQMMvDrS.wvkOnEWBIBJwm3kLsq','1441044277@qq.com','1','1','1399346040','uploads/avatar/201405/small_31_c696db73478.jpg','nicename','这个家伙很懒，什么都不写','http://www.baidu.com','','','127.0.0.1','4');
