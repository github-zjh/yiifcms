...
CREATE TABLE `yii_mail_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='发送邮件日志';
...
INSERT INTO `yii_session` VALUES('kq3b5m493pluibc5mup2caibs0','1400235017','Yii.CCaptchaAction.33c9b0a4.site.captcha|s:6:\"lu7a9e\";Yii.CCaptchaAction.33c9b0a4.site.captchacount|i:1;admin__returnUrl|s:10:\"/admin.htm\";Yii.CCaptchaAction.33c9b0a4.admin/default.captcha|s:4:\"lcdd\";Yii.CCaptchaAction.33c9b0a4.admin/default.captchacount|i:5;admin__id|s:1:\"1\";admin__name|s:9:\"zjh_admin\";admingroupid|s:2:\"10\";admingroupname|s:15:\"系统管理员\";adminemail|s:14:\"xb_zjh@126.com\";admin__states|a:3:{s:7:\"groupid\";b:1;s:9:\"groupname\";b:1;s:5:\"email\";b:1;}');
INSERT INTO `yii_session` VALUES('0rhlpdvmgleakdbotrne0vekc4','1400232329','');
