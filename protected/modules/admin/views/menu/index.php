...
<table class="content_list">
  <form method="post" action="<?php echo $this->createUrl('/admin/menu/batch');?>" name="cpform" >
    <tr class="tb_header">
      <th width="8%"> ID</th>
    ...
    <tr class="tb_list">
      ...
      <td ><?php echo $row['str_repeat'] ?><a href="<?php echo $this->createUrl('create',array('id'=>$row['id']))?>"><img src="<?php echo $this->_baseUrl?>/static/admin/images/insert.png" align="absmiddle" /></a> <a href="<?php echo  $this->createUrl('update',array('id'=>$row['id']))?>"><?php echo $row['menu_name'] ?></a>
