<div id="contentHeader">
    ...
    <div class="searchArea">
        ...
        <div class="search right">
            <?php $this->beginWidget('CActiveForm', array('id' => 'searchForm', 'method' => 'get', 'action' => array('page'), 'htmlOptions' => array('name' => 'xform'))); ?>
...
<?php $form = $this->beginWidget('CActiveForm', array('action' => $this->createUrl('batch'), 'htmlOptions' => array('name' => 'cpform'))); ?>
    <table class="content_list">    
        <tr class="tb_header">
            ...
            <th width="15%"><?php echo $form->label($model, 'status'); ?></th>
