<div id="contentHeader">
    <h3><?php echo Yii::t('admin', 'Soft Manage'); ?></h3>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="content_list"> 
        <thead>
            <tr class="tb_header">
                ...
                <th width="15%"><?php echo $form->label($model, 'update_time'); ?></th>
        ...
        <?php foreach ($datalist as $row): ?>
            <tr class="tb_list" <?php if ($row->status == 'N'): ?>style=" background:#F0F7FC"<?php endif ?>>
                ...
                <td >
                    ...
                    <a href="<?php echo $this->createUrl('/soft/view', array('id' => $row['id'])) ?>" target="_blank"><img src="<?php echo $this->module->assetsUrl; ?>/images/view.png" align="absmiddle" /></a>
                </td>
            </tr>
            <?php endforeach; ?>
            <tr class="operate">
