...
<table class="form_table">
    ...
    <tr>
        <td><?php echo $model->total_page; ?></td>
    </tr>        
...
<?php $this->endWidget();?>
<iframe name="spiderResult" id="spiderIframe" style="margin-top:20px; border:0; width:80%; height:300px;"></iframe>
