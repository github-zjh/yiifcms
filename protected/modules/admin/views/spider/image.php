<div id="contentHeader">
    ...
    <div class="searchArea">
        <ul class="action left" >
            <li><a href="<?php echo $this->createUrl('imageCreate') ?>" class="actionBtn"><span><?php echo Yii::t('admin', 'Add'); ?></span></a></li>
            <li><a href="<?php echo $this->createUrl('batch', array('command' => 'truncate', 'status' => SpiderImageList::STATUS_C, 'type' => 'image')) ?>" class="actionBtn"><span><?php echo Yii::t('admin', 'Truncate Spider Data'); ?></span></a></li>
            <li><a href="<?php echo $this->createUrl('batch', array('command' => 'truncate', 'status' => SpiderImageList::STATUS_SUCCESS, 'type' => 'image')) ?>" class="actionBtn"><span><?php echo Yii::t('admin', 'Truncate Import Data'); ?></span></a></li>
        </ul>
        <div class="search right">
            <?php $this->beginWidget('CActiveForm', array('method' => 'get', 'action' => array('spider/image'))); ?>
            <?php echo Yii::t('model', 'SpiderImageListStatus'); ?>
            ...
            <?php echo Yii::t('model', 'SpiderImageListTitle'); ?>
    ...
    <table class="content_list">    
        ...
        <?php foreach ($datalist as $row): ?>
            <tr class="tb_list">
                ...
                <td>
                    <a href="<?php echo $this->createUrl('imageUpdate', array('id' => $row->id)) ?>"><img src="<?php echo $this->module->assetsUrl; ?>/images/update.png" align="absmiddle" /></a>&nbsp;&nbsp;
                    <a href="<?php echo $this->createUrl('batch', array('command' => 'deleteData', 'id' => $row->id, 'type' => 'image')) ?>" class="confirmSubmit"><img src="<?php echo $this->module->assetsUrl; ?>/images/delete.png" align="absmiddle" /></a>&nbsp;&nbsp;
                </td>
            </tr>
        <?php endforeach; ?>
        <tr>
