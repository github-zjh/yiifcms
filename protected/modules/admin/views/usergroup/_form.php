                ...
                <table>
                    ...
                    <?php foreach ((array) $acls as $ak => $acl): ?>
                        <tr id="<?php echo $ak . '_id'; ?>">	  	 		
                            <td style="width:8%; border:1px solid #CCCCCC;"><input type="checkbox" name="acls[]" value=""  onclick="selectAll('<?php echo $ak . '_id'; ?>', this.checked)"/><strong style="color:#000000;"><?php echo Yii::t('acl', $ak); ?></strong></td>
