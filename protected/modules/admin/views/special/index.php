...
<table class="content_list">
  <form method="post" action="<?php echo $this->createUrl('batch')?>" name="cpform" >
    ...
    <tr class="tb_list">
      ...
      <a href="<?php echo  $this->createUrl('batch',array('command'=>'specialDelete', 'id'=>$row->id))?>" class="confirmSubmit"><img src="<?php echo $this->module->assetsUrl;?>/images/delete.png" align="absmiddle" /></a></td>
    </tr>
    <?php endforeach;?>
    <tr>
      <td colspan="5"><div class="cuspages right">
        ...
        <div class="fixsel" >
          ...
          <select name="command">
            ...
            <option value="specialDelete"><?php echo Yii::t('admin','Delete');?></option>
          </select>
