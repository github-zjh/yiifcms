...
class Page extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('title, seo_title, seo_keywords, link', 'length', 'max'=>100),
			...
			array('id, title, introduce, content, seo_title, seo_keywords, seo_description, link, sort_order, view_count, status, create_time, update_time', 'safe', 'on'=>'search'),
		);
	}
